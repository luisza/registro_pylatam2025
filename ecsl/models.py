...
class PaymentOption(models.Model):
    ...
    identification = models.CharField(max_length=30, verbose_name=_('Identificación'), null=True)
...
class Inscription(models.Model):
    ...
    identification = models.CharField(max_length=12, verbose_name=_('Identificación en su país'), null=True)
    born_date = models.DateField(verbose_name=_('Fecha de Nacimiento'), null=True)
    institution = models.CharField(max_length=12, null=True, blank=True, verbose_name=_('Institución'))
    gender = models.CharField(max_length=9, choices=gender_choice, verbose_name=_('Género'), default='Masculino')
    nationality = models.CharField(max_length=12, choices=PAIS,  verbose_name=_('Nacionalidad'))
